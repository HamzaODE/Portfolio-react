                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="head-top-contact">
                                <span className="phone_contact">+01 234 567 890</span>
                                <span className="email_contact">chat@example.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 offset-md-1 col-sm-12 pl-20">
                                ...
                                <div className="hero-content wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".6s">
                                    <h2 data-splitting className="top-title pt-30 wow fadeInUp" data-wow-duration=".001s" data-wow-delay=".001s">Devid <span className="colored">William.</span></h2>
                                    <div className="typed-strings">
                                        <p> <span className="type_color">Creative Designer</span></p>
                                        <p> <span className="type_color">Wordpress Developer</span></p>
                                        <p> <span className="type_color">Python Developer</span></p>
                                    </div>
                                    <p className="text-16 header_type_text text-white mb-2 mb-md-3">
                                        <span className="typed"></span>
                                    </p>
                                    <p className="header-intro-text wow fadeInUp pt-10" data-wow-duration=".6s" data-wow-delay=".8s">I have been working since 2012. I am proficient in ui design, digital marketing & web development.</p>
